...
- Templates requiring updates:
  - ⚠ `.claude/skills/gradle-validation/SKILL.md` (encodes the withdrawn single-gate rule)
  - ⚠ `.claude/skills/orchestration/SKILL.md` (re-runs the same gate as "independent verification")
  - Note: neither skill file exists on disk, though `CLAUDE.md` §1/§3 mandates both. The warnings
    stand as requirements for whoever authors them, not as pending edits to existing files.
  - ✅ .specify/templates/plan-template.md
  - ✅ .specify/templates/spec-template.md
  - ✅ .specify/templates/tasks-template.md
- Follow-up TODOs:
  - None. The previous draft carried a TODO claiming `mockphone/readme.md` documents 16-byte
    frames; that was a misreading. Its table is headed `Offset`, and `16` is the byte offset of
    `playerId`. The readme states "Total: 20 bytes" and agrees with this constitution. The real
    defect there is unrelated: it cites the retired `couchraoke_spec.md v4.20` and §8.x section
    numbers that no longer exist in `tv_app.md`.
-->
...
vocabulary defined in the delivery plan (`couchraoke-spec/plan.md` §2, "Gate vocabulary" — not a
feature's own `specs/*/plan.md`): **U** (JVM unit test), **S** (screenshot verified against a
...
**Version**: 2.0.0 | **Ratified**: 2026-04-12 | **Last Amended**: 2026-08-19
