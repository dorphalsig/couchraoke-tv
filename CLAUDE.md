...
- Kotlin 2.3.10 on Java 11 + Ktor server CIO 3.4.1, ktor-server-websockets 3.4.1, kotlinx-serialization-json 1.10.0, kotlinx-coroutines-core 1.9.0, JmDNS 3.6.3, OkHttp via existing Media3/Coil stack (005-network-protocol)
- In-memory session/network state only; no persistence (005-network-protocol)
...
## Recent Changes
- 005-network-protocol: Added Kotlin 2.3.10 on Java 11 + Ktor server CIO 3.4.1, ktor-server-websockets 3.4.1, kotlinx-serialization-json 1.10.0, kotlinx-coroutines-core 1.9.0, JmDNS 3.6.3, OkHttp via existing Media3/Coil stack
